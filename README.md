...
> Rule Engine v2 — **Attention Alert**，不是選股、不是預測
...
| 技術訊號    |   6 | 52 週高低、MA 排列、RSI 極端值                 |
| 價量背離    |   4 | 價漲量縮、高檔爆量、低檔吸籌                       |
| 基本面分析   |   7 | 營收成長、殖利率、PE/PBR 估值                   |

> 詳細規則請參閱 [docs/RULE_ENGINE.md](docs/RULE_ENGINE.md)
